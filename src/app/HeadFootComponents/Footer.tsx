    ...
    return(
      ...
      <div className="relative max-w-screen-xl mx-auto">
        <div className="bg-blue-600 gap-3 rounded-md flex flex-wrap items-center justify-between sm:px-8 max-sm:px-4 py-4 absolute top-[-66px] w-full">
          <h6 className="text-white sm:text-xl max-sm:text-base font-semibold">Kickstart Your Shopping Today</h6>
          <a href="/TopProduct">
          <button type='button'
            className="px-4 py-2 text-sm rounded-full text-blue-600 gap-2 bg-white">Shop Now
            </button>
            </a>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 pt-10">
          <div className="lg:col-span-2 max-w-md">
            ...
            <p className="text-gray-400 text-base">We Provide You Top Notch Quality Products That You Like So Dont Miss The Opportunity And Order Now!!.</p>
          </div>

          <div>
            <h4 className="text-lg font-semibold mb-6 text-gray-200">Services</h4>
            <ul className="space-y-4">
              <li><a href="javascript:void(0)" className="text-gray-400 hover:text-gray-300 text-base">Ecommerce</a></li>
              <li><a href="javascript:void(0)" className="text-gray-400 hover:text-gray-300 text-base">Web
                Development</a></li>
              <li><a href="javascript:void(0)" className="text-gray-400 hover:text-gray-300 text-base">UI/UX
                Design</a></li>
              <li><a href="javascript:void(0)" className="text-gray-400 hover:text-gray-300 text-base">Digital
                Marketing</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="text-gray-400 text-base">Karachi, Sindh, Pakistan</li>
              <li className="text-gray-400 text-base">ahmedpubgking3388@gmail.com</li>
              <li className="text-gray-400 text-base">+92 3368952826</li>
            </ul>
          </div>
      ...
      <div className="bg-gray-900 py-4 px-4 -mx-8 text-center mt-10">
        <p className='text-gray-400 text-base'>© AhmedFabs. All rights reserved.</p>
      </div>
    </footer>
    )
}